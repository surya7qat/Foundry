        ...
        <div className="inventory-master-page">
            ...
            <div className="glass-panel" style={{padding: '2rem'}}>
                ...
                <div className="data-table-container" ref={tableContainerRef}>
                    <table className="glass-table">
                        ...
                        <tbody>
                            {materials.length === 0 ? (
                                <tr><td colSpan={3} style={{textAlign:'center', padding:'2rem'}}>No materials registered yet.</td></tr>
                            ) : materials.map(mat => (
            ...
            <div className="data-table-wrapper mobile-only-view">
                <div className="mobile-card-list" style={{ padding: '1rem' }}>
                    {materials.length === 0 ? (
                        <div style={{ textAlign: 'center', padding: '2rem', color: '#888' }}>No materials found.</div>
                    ) : materials.map(mat => (
            ...
            <div className="form-panel">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="input-group">
                        ...
                        <input className="glass-input" required maxLength={15} pattern="^[A-Za-z0-9_\-]+$" title="Alphanumeric, dashes, and underscores only. Max 15 chars." placeholder="" value={formData.material_id} onChange={e => setFormData({...formData, material_id: e.target.value.toUpperCase()})} />
