                                ...
                                <tbody>
                                    {rejections.length === 0 ? (
                                        ...
                                        <tr key={rej.id}>
                                            ...
                                            <td style={{ fontWeight: '500' }} className="wrap-text" title={rej.supplier_name}>{rej.supplier_name}</td>
                                            ...
                                            <td style={{ color: '#ccc' }} className="wrap-text" title={rej.remarks}>{rej.remarks || '-'}</td>
